...
function filterBlogs(category) {
    ...
    document.querySelectorAll('.filter-btn').forEach(btn => {
        btn.classList.remove('active', 'bg-warm-terracotta', 'text-white');
        btn.classList.add('text-warm-terracotta');
    });

    event.target.classList.add('active', 'bg-warm-terracotta', 'text-white');
    event.target.classList.remove('text-warm-terracotta');
}
